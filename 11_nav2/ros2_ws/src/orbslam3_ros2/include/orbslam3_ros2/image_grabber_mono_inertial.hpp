#ifndef IMAGE_GRABBER_MONO_INERTIAL_HPP
#define IMAGE_GRABBER_MONO_INERTIAL_HPP
...
class ImageGrabberInertial : public std::enable_shared_from_this<ImageGrabberInertial>
{
private:
    bool first_pose;
public:
    ImageGrabberInertial();
    ImageGrabberInertial(std::shared_ptr<ORB_SLAM3::System> pSLAM, bool bClahe,
...
#endif // IMAGE_GRABBER_MONO_INERTIAL_HPP
